...
class SensorData:
  ...
  def load(self, filename):
    with open(filename, 'rb') as f:
      ...
      self.frames = []
      for i in tqdm(range(num_frames), desc='loading'):
        frame = RGBDFrame()
        frame.load(f)
  ...
  def export_depth_images(self, output_path, image_size=None, frame_skip=1):
    ...
    for f in tqdm(range(0, len(self.frames), frame_skip), desc='export depth'):
  ...
  def export_color_images(self, output_path, image_size=None, frame_skip=1):
    ...
    for f in tqdm(range(0, len(self.frames), frame_skip), desc='expot color'):
  ...
  def export_poses(self, output_path, frame_skip=1):
    ...
    for f in tqdm(range(0, len(self.frames), frame_skip), desc='export pose'):
